  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      <Link
        to="/lab-interface"
        state={{ sourceLabel }}
        className="group inline-flex items-center gap-3 rounded-full border border-sky-300/20 bg-[#08111f]/80 px-4 py-3 text-sm theme-text-primary shadow-[0_8px_30px_rgba(2,8,23,0.45)] backdrop-blur-xl transition hover:-translate-y-0.5 hover:bg-[#0b1627]/90"
      >
        <span className="relative flex h-8 w-8 items-center justify-center rounded-full border border-sky-300/20 theme-chip">
