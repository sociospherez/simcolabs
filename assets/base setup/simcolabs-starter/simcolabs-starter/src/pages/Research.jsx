export default function Research() {
  return (
    <section className="mx-auto max-w-5xl px-6 py-20">
      ...
      <h1 className="mt-2 text-4xl font-semibold tracking-tight theme-text-primary">Themes in motion.</h1>
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        {[
          ...
          <div key={item} className="rounded-2xl border border-[var(--border-subtle)] theme-surface-strong/5 p-5 text-slate-200">
            {item}
          </div>
        ))}
      </div>
